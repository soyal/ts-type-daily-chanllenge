...
// type ExtractArrItem<T> = T extends (infer I)[] ? [...ExtractArrItem<I>] : [T]
type Flatten<F, A extends any[] = []> = F extends [infer L, ...infer R] ? (
    L extends any[] ? Flatten<[...L, ...R], A> : Flatten<[...R], [...A, L]>
) : A
